...
public class LibOutStrings {
    ...
    public static String palabraMasLarga() {
        ...
        palabra1 = LibInStrings.ingresarTexto("Ingrese la primera palabra: ");
        palabra2 = LibInStrings.ingresarTexto("Ingrese la segunda palabra: ");
        palabra3 = LibInStrings.ingresarTexto("Ingrese la tercera palabra: ");
    ...
    public static String numerosDeVocales() {
        int vocales;
        vocales = 0;
        String frase = LibInStrings.ingresarFrase();
        frase = frase.toLowerCase();
